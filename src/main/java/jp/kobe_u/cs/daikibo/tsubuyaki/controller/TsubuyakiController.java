...
public class TsubuyakiController {  
    ...
    String showTsubuyakiList(Model model) {  
        ...
        List<Tsubuyaki> searchList = ts.searchTsubuyaki(null);
    ...
    //つぶやきを内容で検索
    @GetMapping("/search")
    public String searchTsubuyaki(@RequestParam String searchword, Model model) {
        ...
        List<Tsubuyaki> searchResults = ts.searchTsubuyaki(searchword);
